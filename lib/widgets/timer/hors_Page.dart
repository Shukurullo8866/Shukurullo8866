...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: isLight ? Color.fromARGB(255, 194, 190, 190) : MyColors.color_indicator,
        ...
        body: Container(
          ...
          child: Column(
              ...
              children: [
                ...
                Text(
                  "Timer",
                  style: TextStyle(fontSize: 25,color: isLight ? Colors.black : Colors.white),
                ),
                Container(
  ...
  Widget buildTimeCard({required String time, required String header}) =>
      Column(
        ...
        children: [
          ...
          Text(header, style: TextStyle(color: Color.fromARGB(255, 169, 102, 246))),
        ],
      );
}